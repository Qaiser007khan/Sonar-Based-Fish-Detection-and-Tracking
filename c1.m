...
videoFile = '2023-07-01_180000.mp4'; % Specify your video file path
...
while hasFrame(vidReader) %&& frameCount < MaxFrame
    ...
    frameDiffMask = bwareaopen(frameDiffMask, 120); % Remove noise
    
    % Combine foreground mask and frame difference mask
